...
//Iyzico
Route::any('/iyzico/payment/callback/{payment_type}/{amount?}/{payment_method?}/{package_id?}/{milestone_request_id?}/{service_package_id?}/{user_id?}', [IyzicoController::class, 'callback'])->name('iyzico.callback');
