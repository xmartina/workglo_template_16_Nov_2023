...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2023 at 10:06 AM
...
CREATE TABLE `addresses` (
  ...
  `addressable_type` char(50) NOT NULL,
...
CREATE TABLE `badges` (
  ...
  `type` char(50) NOT NULL COMMENT 'project/earning/membership',
...
CREATE TABLE `documents` (
  ...
  `documentable_type` char(50) NOT NULL,
  `name` varchar(191) NOT NULL,
  `obscure` varchar(191) NOT NULL,
...
CREATE TABLE `freelancer_accounts` (
  ...
  `paypal_acc_name` varchar(255) DEFAULT NULL,
...
CREATE TABLE `freelancer_services` (
  ...
  `about_service` longtext NOT NULL,
...
CREATE TABLE `freelancer_services_packages` (
  ...
  `revision_limit` varchar(255) DEFAULT NULL,
...
CREATE TABLE `notifications` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL,
  `showing_panel` varchar(255) DEFAULT NULL,
...
CREATE TABLE `packages` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `type` char(20) NOT NULL COMMENT 'client/freelancer',
  `name` varchar(191) NOT NULL,
  `price` double(8,2) NOT NULL,
  `number_of_days` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `commission` double(8,2) DEFAULT 0.00,
  `commission_type` char(20) DEFAULT 'amount' COMMENT 'flat/percenage',
...
(1, 'paypal', '0', '2023-08-20 23:47:34', '2023-08-20 23:47:34'),
(2, 'stripe', '0', '2023-08-20 23:47:34', '2023-08-20 23:47:34'),
(3, 'sslcommerz', '0', '2023-08-20 23:47:34', '2023-08-20 23:47:34'),
(4, 'instamojo', '0', '2023-08-20 23:47:34', '2023-08-20 23:47:34'),
(5, 'paystack', '0', '2023-08-20 23:47:34', '2023-08-20 23:47:34'),
(6, 'paytm', '0', '2023-08-20 23:47:34', '2023-08-20 23:47:34'),
(7, 'flutterwave', '0', '2023-08-20 23:47:34', '2023-08-20 23:47:34'),
(8, 'mercadopago', '0', '2023-08-20 23:47:34', '2023-08-20 23:47:34'),
(9, 'iyzico', '0', '2023-09-20 08:06:45', '2023-09-20 08:06:45');
...
(123, 'show all services', 'web', '2023-05-29 06:49:56', '2023-05-29 06:49:56'),
(124, 'show cancelled services', 'web', '2023-05-29 06:49:56', '2023-05-29 06:49:56'),
(125, 'show service cancel requests', 'web', '2023-05-29 06:49:56', '2023-05-29 06:49:56');
...
CREATE TABLE `portfolios` (
  ...
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(191) NOT NULL,
  `type` varchar(191) NOT NULL COMMENT 'web design/personal/app etc...',
...
CREATE TABLE `projects` (
  ...
  `type` char(20) NOT NULL COMMENT 'fixed/hourly/long_term',
...
--
-- Table structure for table `project_conversations`
--
...
CREATE TABLE `service_payments` (
  ...
  `service_package_type` varchar(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `service_owner_id` bigint(20) NOT NULL,
  `amount` decimal(10,0) NOT NULL,
  `payment_type` varchar(20) NOT NULL DEFAULT 'service_payment',
...
(32, 'slider_section_subtitle', '<font color=\"#1b1b28\" face=\"Montserrat, sans-serif\"><span style=\"font-size: 20px;\">Millions of small businesses use Freelancer to turn their ideas into reality.</span></font>', '2020-05-04 11:59:56', '2022-11-21 07:39:37'),
...
(37, 'how_it_works_subtitle', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', '2020-05-04 11:43:42', '2022-11-21 07:41:54'),
(38, 'how_it_works_description_1', '<span open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;=\"\" text-align:=\"\" justify;\"=\"\" style=\"font-weight: bolder; margin: 0px; padding: 0px;\">Lorem Ipsum</span><span open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;=\"\" text-align:=\"\" justify;\"=\"\"> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the.</span>', '2020-05-04 11:43:42', '2022-11-21 07:41:54'),
(39, 'how_it_works_description_2', '<span open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;=\"\" text-align:=\"\" justify;\"=\"\" style=\"font-weight: bolder; margin: 0px; padding: 0px;\">Lorem Ipsum</span><span open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;=\"\" text-align:=\"\" justify;\"=\"\"> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the.</span><br>', '2020-05-04 11:43:42', '2022-11-21 07:41:54'),
(40, 'how_it_works_description_3', '<span style=\"font-weight: bolder; margin: 0px; padding: 0px; font-family: \" open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;=\"\" text-align:=\"\" justify;\"=\"\">Lorem Ipsum</span><span style=\"font-family: \" open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;=\"\" text-align:=\"\" justify;\"=\"\"> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the.</span>', '2020-05-04 11:43:42', '2022-11-21 07:40:08'),
(41, 'how_it_works_show', 'on', '2020-05-04 12:10:42', '2020-05-04 12:10:42'),
(42, 'how_it_works_banner_1', NULL, '2020-05-04 12:10:42', '2020-06-06 01:00:59'),
(43, 'how_it_works_banner_2', NULL, '2020-05-04 12:10:42', '2020-06-06 01:03:08'),
...
(49, 'featured_category_subtitle', 'We have expert freelancers in the below categories', '2020-05-04 12:10:42', '2022-11-21 07:41:19'),
...
(74, 'about_description_footer', '<p>About</p>', '2020-07-12 11:38:23', '2022-11-21 07:42:19'),
(75, 'widget_one', 'Link Widget One', '2020-07-12 05:53:48', '2020-08-07 08:30:42'),
(76, 'widget_one_labels', '[\"Link 1\",\"Link 2\",\"Link 3\"]', '2020-07-12 05:53:48', '2022-11-21 07:44:31'),
(77, 'widget_one_links', '[\"#\",\"#\",\"#\"]', '2020-07-12 05:53:48', '2022-11-21 07:44:31'),
...
(91, 'copyright_text', '<p>© 2022 Company Limited</p>', '2020-07-12 12:24:08', '2022-11-21 07:43:43'),
...
(107, 'current_version', '3.4.0', '2020-08-27 12:53:33', '2020-08-27 12:53:33'),
(108, 'service_section_show', '', '2022-06-06 01:06:44', '2022-06-06 01:06:44'),
...
(120, 'cta_section_banner', '', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
(121, 'cta_section_title_client', 'Ready to Get Started', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
(122, 'cta_section_subtitle_client', 'You can post a project, select from premade projects or contact your favorite freelancer through workdesk.<br><br>It is easy & your payment is secured.', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
(123, 'cta_section_title_freelancer', 'Ready to Get Started', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
(124, 'cta_section_subtitle_freelancer', 'You can bid a project, select from premade projects or contact your client through workdesk.<br><br>It iss easy & your payment is secured.', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
(125, 'paystack_sandbox_checkbox', '0', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
(126, 'service_section_subtitle', 'Choose from our premade packages by our freelancers', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
...
(129, 'widget_three_labels', '[\"View Projects\",\"Freelancers\",\"Services\",\"All Categories\",\"Packages\",\"Profile\"]', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
(130, 'widget_three_links', '[\"http://\",\"http://\",\"http://\",\"http://\",\"http://\",\"http://\"]', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
(131, 'widget_four', 'For Freelancers', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
(132, 'widget_four_labels', '[\"Profile\",\"All Services\",\"Following Clients\",\"Packages\"]', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
(133, 'widget_four_links', '[\"http://\",\"http://\",\"http://\",\"http://\"]', '2022-11-21 12:48:22', '2022-11-21 12:48:22'),
...
(138, 'flutterwave_activation_checkbox', '1', '2023-02-23 02:05:30', '2023-02-23 02:05:30'),
(139, 'running_project_chat_activation_checkbox', '0', '2023-05-29 06:49:56', '2023-05-29 06:49:56');
...
CREATE TABLE `transactions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `type` char(50) NOT NULL COMMENT 'package/milestone/withdraw/wallet in',
  `amount` double(8,2) NOT NULL,
  `method` char(20) NOT NULL COMMENT 'paypal/stripe etc..',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(3, 'en', 'Freelancer Subscription', 'Freelancer Subscription', '2022-02-14 02:15:11', '2022-02-14 02:15:11'),
...
(8, 'en', 'Top Freelancer Packages', 'Top Freelancer Packages', '2022-02-14 02:15:11', '2022-02-14 02:15:11'),
...
(12, 'en', 'New Freelancers', 'New Freelancers', '2022-02-14 02:15:11', '2022-02-14 02:15:11'),
...
(29, 'en', 'Freelancer Package', 'Freelancer Package', '2022-02-14 02:15:11', '2022-02-14 02:15:11'),
...
(78, 'en', 'Freelancers', 'Freelancers', '2022-02-14 02:16:08', '2022-02-14 02:16:08'),
(79, 'en', 'All Freelancers', 'All Freelancers', '2022-02-14 02:16:08', '2022-02-14 02:16:08'),
(80, 'en', 'Freelancer Packages', 'Freelancer Packages', '2022-02-14 02:16:08', '2022-02-14 02:16:08'),
(81, 'en', 'Freelancer Skills', 'Freelancer Skills', '2022-02-14 02:16:08', '2022-02-14 02:16:08'),
(82, 'en', 'Freelancer Badges', 'Freelancer Badges', '2022-02-14 02:16:08', '2022-02-14 02:16:08'),
...
(88, 'en', 'Freelancers Reviews', 'Freelancers Reviews', '2022-02-14 02:16:08', '2022-02-14 02:16:08'),
...
(94, 'en', 'Freelancer Withdraw Requests', 'Freelancer Withdraw Requests', '2022-02-14 02:16:08', '2022-02-14 02:16:08'),
(95, 'en', 'Freelancer Payouts', 'Freelancer Payouts', '2022-02-14 02:16:08', '2022-02-14 02:16:08'),
...
(116, 'en', 'Freelancer Payment', 'Freelancer Payment', '2022-02-14 02:16:08', '2022-02-14 02:16:08'),
...
(126, 'en', 'I want to Hire', 'I want to Hire', '2022-06-06 01:06:44', '2022-06-06 01:06:44'),
(127, 'en', 'I want to Work', 'I want to Work', '2022-06-06 01:06:44', '2022-06-06 01:06:44'),
...
(169, 'en', 'Freelancer Lists', 'Freelancer Lists', '2022-06-06 01:07:33', '2022-06-06 01:07:33'),
...
(255, 'en', 'Freelancer', 'Freelancer', '2022-11-21 07:06:58', '2022-11-21 07:06:58'),
...
(259, 'en', 'Already a Freelancer', 'Already a Freelancer', '2022-11-21 07:06:58', '2022-11-21 07:06:58'),
...
(296, 'en', 'Title (Freelancer)', 'Title (Freelancer)', '2022-11-21 07:15:08', '2022-11-21 07:15:08'),
(297, 'en', 'Sub title (Freelancer)', 'Sub title (Freelancer)', '2022-11-21 07:15:08', '2022-11-21 07:15:08'),
...
INSERT INTO `users` (`id`, `provider_id`, `user_type`, `name`, `user_name`, `email`, `email_verified_at`, `password`, `remember_token`, `photo`, `cover_photo`, `verification_code`, `banned`, `fcm_token`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, NULL, 'admin', 'Admin', NULL, 'admin@example.com', '2022-11-21 07:06:53', '$2y$10$k1cu6E8/EC.JUWPU8szDo.lj2ATzvBXh/ZLlAgHJrfDwtePsUmY1S', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2022-11-21 07:06:53', NULL);
...
CREATE TABLE `verifications` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `type` char(50) NOT NULL COMMENT 'email/phone/identity/payment',
  `user_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Indexes for table `project_conversations`
--
...
--
-- AUTO_INCREMENT for table `project_conversations`
--
ALTER TABLE `project_conversations`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
