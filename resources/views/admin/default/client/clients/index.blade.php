                        ...
                        @foreach($clients as $key => $client)
                            @if ($client->user != null)
                                <tr>
                                    ...
                                    @php
                                        $verification = \App\Models\Verification::where('user_id', $client->user_id)->first();
                                    @endphp
                                    <td>
                                    ...
                                    <td class="text-right">
                                        @if ($client->user != null)
                                            <a class="btn btn-soft-warning btn-icon btn-circle btn-sm btn icon" href="#" title="{{translate('Add Wallet Balance')}}" onclick="show_wallet_modal({{ $client->user->id }})">
