		...
		<div class="card-body">
			...
			<div class="form-group ">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="{{ translate('page-title') }}" name="slug">
				</div>
				<small class="form-text text-muted">{{ translate('Use character, number, hypen only') }}</small>
			</div>
			<div class="form-group">
				<label>{{ translate('Add Content') }}</label>
				<textarea class="aiz-text-editor form-control" placeholder="{{ translate('Content..') }}" data-min-height="400" name="content"></textarea>
			</div>
		</div>
