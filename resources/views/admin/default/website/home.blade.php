    ...
    <div class="">
                ...
                <div class="card-header">
                    ...
                    <div>
                        <label class="aiz-switch mb-0">
                            ...
                            <input type="checkbox" name="slider_section_show"
                                @if (App\Models\SystemConfiguration::where('type', 'slider_section_show')->first()->value == 'on') checked @endif>
                            <span></span>
                        </label>
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{ translate('Title') }}"
                            value="{{ App\Models\SystemConfiguration::where('type', 'slider_section_title')->first()->value }}"
                            name="slider_section_title">
                    </div>
                    <div class="form-group">
                        ...
                        <textarea class="aiz-text-editor form-control"
                            data-buttons='[["font", ["bold", "underline", "italic"]],["insert", ["link"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]'
                    ...
                    <div class="form-group">
                        <label class="form-label" for="signinSrEmail">{{ translate('Slider Images') }} <small
                                class="text-muted">({{ translate('Recommended size') }} 1920x1080)</small></label>
                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                            ...
                            <input type="hidden" name="sliders"
                                value="{{ App\Models\SystemConfiguration::where('type', 'sliders')->first()->value }}"
        ...
        <div class="card">
            <form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label class="form-label" for="signinSrEmail">{{ translate('Clients Logos') }} <small
                                class="text-muted">({{ translate('Recommended size') }} 190x80)</small></label>
                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                            <div class="input-group-prepend">
                                <div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
                            </div>
                            ...
                            <input type="hidden" name="client_logos"
                                value="{{ App\Models\SystemConfiguration::where('type', 'client_logos')->first()->value }}"
                                class="selected-files">
                        </div>
                ...
                <div class="card-header">
                    ...
                    <div>
                        <label class="aiz-switch mb-0">
                            ...
                            <input type="checkbox" name="how_it_works_show"
                                @if (App\Models\SystemConfiguration::where('type', 'how_it_works_show')->first()->value == 'on') checked @endif>
                            <span></span>
                        </label>
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{ translate('Title') }}"
                            ...
                            value="{{ App\Models\SystemConfiguration::where('type', 'how_it_works_title')->first()->value }}">
                    </div>
                    <div class="form-group">
                        <label>{{ translate('Sub title') }}</label>
            ...
            <form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{ translate('Title') }}"
                            name="latest_project_title"
                            value="{{ App\Models\SystemConfiguration::where('type', 'latest_project_title')->first()->value }}">
                    </div>
                    <div class="form-group">
                        <label>{{ translate('Sub title') }}</label>
            ...
            <form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-header">
                    ...
                    <div>
                        <label class="aiz-switch mb-0">
                            ...
                            <input type="checkbox" name="featured_category_show"
                                @if (App\Models\SystemConfiguration::where('type', 'featured_category_show')->first()->value == 'on') checked @endif>
                            <span></span>
                        </label>
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{ translate('Title') }}"
                            name="featured_category_title"
                            value="{{ App\Models\SystemConfiguration::where('type', 'featured_category_title')->first()->value }}">
                    </div>
                    <div class="form-group">
                        <label>{{ translate('Sub title') }}</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="featured_category_left_banner"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="featured_category_right_banner"
                                value="{{ App\Models\SystemConfiguration::where('type', 'featured_category_right_banner')->first()->value }}"
                                class="selected-files">
                        </div>
                        <div class="file-preview box"></div>
                    </div>
        ...
        <div class="card">
            <form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-header">
                    <h6 class="fw-600 mb-0">{{ translate('Services Section') }}</h6>
                    <div>
                        <label class="aiz-switch mb-0">
                            <input type="hidden" name="types[]" value="service_section_show">
                            <input type="checkbox" name="service_section_show"
                                @if (App\Models\SystemConfiguration::where('type', 'service_section_show')->first()->value == 'on') checked @endif>
                            <span></span>
                        </label>
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label>{{ translate('Title') }}</label>
                        <input type="hidden" name="types[]" value="service_section_title">
                        <input type="text" class="form-control" placeholder="{{ translate('Title') }}"
                            name="service_section_title"
                            value="{{ App\Models\SystemConfiguration::where('type', 'service_section_title')->first()->value }}">
                    </div>
                    <div class="form-group">
                        <label>{{ translate('Title') }}</label>
                        <input type="hidden" name="types[]" value="service_section_subtitle">
                        <input type="text" class="form-control" placeholder="{{ translate('Subtitle') }}"
                            name="service_section_subtitle"
                            value="{{ App\Models\SystemConfiguration::where('type', 'service_section_subtitle')->first() ? 
                                        App\Models\SystemConfiguration::where('type', 'service_section_subtitle')->first()->value : ''}}">
                    </div>
                    <div class="form-group">
        ...
        <div class="card">
            <form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label>{{ translate('Title (Client)') }}</label>
                        <input type="hidden" name="types[]" value="cta_section_title_client">
                        <input type="text" class="form-control" placeholder="{{ translate('Title') }}"
                            name="cta_section_title_client"
                            value="{{ App\Models\SystemConfiguration::where('type', 'cta_section_title_client')->first() ? App\Models\SystemConfiguration::where('type', 'cta_section_title_client')->first()->value : '' }}">
                    </div>
                    <div class="form-group">
                        <label>{{ translate('Sub title (Client)') }}</label>
                        <input type="hidden" name="types[]" value="cta_section_subtitle_client">
                        <textarea class="form-control resize-off" placeholder="{{ translate('Type..') }}" name="cta_section_subtitle_client">@php
							echo App\Models\SystemConfiguration::where('type', 'cta_section_subtitle_client')->first() ? App\Models\SystemConfiguration::where('type', 'cta_section_subtitle_client')->first()->value : '';
						@endphp</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" name="types[]" value="cta_section_banner">
                            <input type="hidden" name="cta_section_banner"
                                value="{{ App\Models\SystemConfiguration::where('type', 'cta_section_banner')->first() ? App\Models\SystemConfiguration::where('type', 'cta_section_banner')->first()->value : '' }}"
                                class="selected-files">
                        </div>
                        <div class="file-preview box"></div>
                    </div>
        ...
        <div class="card">
            <form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-header">
                    <h6 class="fw-600 mb-0">{{ translate('Blog Section') }}</h6>
                    <div>
                        <label class="aiz-switch mb-0">
            ...
            <form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{ translate('Title') }}"
                            name="meta_title"
                            value="{{ App\Models\SystemConfiguration::where('type', 'meta_title')->first()->value }}">
                    </div>
                    <div class="form-group">
                        <label>{{ translate('Meta description') }}</label>
                        <input type="hidden" name="types[]" value="meta_description">
                        <textarea class="resize-off form-control" placeholder="{{ translate('Description') }}" name="meta_description">@php
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="resize-off form-control" placeholder="{{ translate('Keyword, Keyword') }}" name="meta_keywords">@php
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="meta_image"
                                value="{{ App\Models\SystemConfiguration::where('type', 'meta_image')->first()->value }}"
                                class="selected-files">
                        </div>
                        <div class="file-preview box"></div>
                    </div>
