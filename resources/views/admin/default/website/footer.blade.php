	...
	<div class="card-body">
		<div class="row gutters-10">
					...
					<div class="card-body">
						<form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
			                ...
			                <div class="form-group">
								...
								<textarea class="aiz-text-editor form-control" name="about_description_footer" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' placeholder="{{ translate('Type..') }}" data-min-height="150">@php
					...
					<div class="card-body">
						<form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="{{ translate('Widget title') }}" name="widget_one" value="{{ App\Models\SystemConfiguration::where('type', 'widget_one')->first()->value }}">
							</div>
			                <div class="form-group">
					...
					<div class="card-body">
						<form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="{{ translate('Widget title') }}" name="widget_two" value="{{ App\Models\SystemConfiguration::where('type', 'widget_two')->first()->value }}">
							</div>
			                <div class="form-group">
								<label>{{ translate('Links') }}</label>
									...
									@if (App\Models\SystemConfiguration::where('type', 'widget_two_labels')->first()->value != null)
										@foreach (json_decode(App\Models\SystemConfiguration::where('type', 'widget_two_labels')->first()->value, true) as $key => $value)
											<div class="row gutters-5">
												<div class="col-4">
													<div class="form-group">
														<input type="text" class="form-control" placeholder="{{ translate('Label') }}" name="widget_two_labels[]" value="{{ $value }}">
													</div>
												</div>
												<div class="col">
													<div class="form-group">
								...
								<button
									...
									data-content='<div class="row gutters-5">
										<div class="col-4">
											<div class="form-group">
												<input type="text" class="form-control" placeholder="{{ translate('Label') }}" name="widget_two_labels[]">
											</div>
										</div>
										<div class="col">
											<div class="form-group">
			...
			<div class="col-lg-6">
					...
					<div class="card-body">
						<form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="{{ translate('Widget title') }}" name="widget_three" value="{{ App\Models\SystemConfiguration::where('type', 'widget_three')->first()->value }}">
							</div>
			                <div class="form-group">
								<label>{{ translate('Links') }}</label>
								<div class="w3-links-target-2">
									...
									@if (App\Models\SystemConfiguration::where('type', 'widget_three_labels')->first()->value != null)
										@foreach (json_decode(App\Models\SystemConfiguration::where('type', 'widget_three_labels')->first()->value, true) as $key => $value)
											<div class="row gutters-5">
												<div class="col-4">
													<div class="form-group">
														<input type="text" class="form-control" placeholder="{{ translate('Label') }}" name="widget_three_labels[]" value="{{ $value }}">
													</div>
												</div>
												<div class="col">
													<div class="form-group">
														<input type="text" class="form-control" placeholder="http://" name="widget_three_links[]" value="{{ json_decode(App\Models\SystemConfiguration::where('type', 'widget_three_links')->first()->value, true)[$key] }}">
													</div>
												</div>
												<div class="col-auto">
													<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
								...
								<button
									...
									data-content='<div class="row gutters-5">
										<div class="col-4">
											<div class="form-group">
												<input type="text" class="form-control" placeholder="{{ translate('Label') }}" name="widget_three_labels[]">
											</div>
										</div>
										<div class="col">
											<div class="form-group">
				...
				<div class="card shadow-none bg-light">
					<div class="card-header">
						<h6 class="mb-0">{{ translate('Link Widget Four') }}</h6>
					</div>
					<div class="card-body">
						<form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
							@csrf
							<div class="form-group">
								<label>{{ translate('Title') }}</label>
								<input type="hidden" name="types[]" value="widget_four">
								<input type="text" class="form-control" placeholder="{{ translate('Widget title') }}" name="widget_four" value="{{ App\Models\SystemConfiguration::where('type', 'widget_four')->first()->value }}">
							</div>
			                <div class="form-group">
								<label>{{ translate('Links') }}</label>
								<div class="w3-links-target-2">
									<input type="hidden" name="types[]" value="widget_four_labels">
									<input type="hidden" name="types[]" value="widget_four_links">
									@if (App\Models\SystemConfiguration::where('type', 'widget_four_labels')->first()->value != null)
										@foreach (json_decode(App\Models\SystemConfiguration::where('type', 'widget_four_labels')->first()->value, true) as $key => $value)
											<div class="row gutters-5">
												<div class="col-4">
													<div class="form-group">
														<input type="text" class="form-control" placeholder="{{ translate('Label') }}" name="widget_four_labels[]" value="{{ $value }}">
													</div>
												</div>
												<div class="col">
													<div class="form-group">
														<input type="text" class="form-control" placeholder="http://" name="widget_four_links[]" value="{{ json_decode(App\Models\SystemConfiguration::where('type', 'widget_four_links')->first()->value, true)[$key] }}">
													</div>
												</div>
												<div class="col-auto">
													<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
								...
								<button
									...
									data-content='<div class="row gutters-5">
										<div class="col-4">
											<div class="form-group">
												<input type="text" class="form-control" placeholder="{{ translate('Label') }}" name="widget_four_labels[]">
											</div>
										</div>
										<div class="col">
											<div class="form-group">
					...
					<div class="card-body">
						<form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="{{ translate('Widget title') }}" name="social_widget_title" value="{{ App\Models\SystemConfiguration::where('type', 'social_widget_title')->first()->value }}">
							</div>
			                <div class="form-group">
...
<div class="card">
	<form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
		@csrf
		<div class="card-header">
			<h6 class="fw-600 mb-0">{{ translate('Footer Apps Link') }}</h6>
			<div>
				<label class="aiz-switch mb-0">
					<input type="hidden" name="types[]" value="app_link_section_show">
					<input type="checkbox" name="app_link_section_show"
						@if (App\Models\SystemConfiguration::where('type', 'app_link_section_show')->first()->value == 'on') checked @endif>
					<span></span>
				</label>
			</div>
		</div>
		<div class="card-body">
			<div class="form-group">
				<label>{{ translate('Android App Link') }}</label>
				<input type="hidden" name="types[]" value="app_link_android">
				<input type="text" class="form-control" placeholder="http://" name="app_link_android" value="{{ App\Models\SystemConfiguration::where('type', 'app_link_android')->first()->value }}">
			</div>
			<div class="form-group">
				<label>{{ translate('Apple App Link') }}</label>
				<input type="hidden" name="types[]" value="app_link_apple">
				<input type="text" class="form-control" placeholder="http://" name="app_link_apple" value="{{ App\Models\SystemConfiguration::where('type', 'app_link_apple')->first()->value }}">
			</div>
			<div class="text-right">
				<button type="submit" class="btn btn-primary">{{ translate('Update') }}</button>
			</div>
