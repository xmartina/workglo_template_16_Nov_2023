            ...
            <tbody>
                @foreach($subscribers as $key => $subscriber)
                  <tr>
                      ...
                      <td class="text-right">
                          <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('admin.subscribers.destroy', $subscriber->id)}}" title="{{ translate('Delete') }}">
