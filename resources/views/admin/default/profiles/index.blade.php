    ...
    <div class="container">
        <div class="col-xl-6 col-lg-6 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin_profile.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="name">{{translate('Name')}}</label>
                            <input type="text" id="name" name="name" placeholder="{{ translate('Name') }}" value="{{ auth()->user()->name }}" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="email">{{translate('Email')}}</label>
                            <input type="email" id="email" name="email" placeholder="{{ translate('Email') }}" value="{{ auth()->user()->email }}" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <input type="hidden" name="profile_photo" class="selected-files" value="{{ auth()->user()->photo }}">
                            </div>
