                ...
                <div class="media align-items-center d-block d-md-flex">
                    ...
                    <div class="media-body d-lg-flex justify-content-between align-items-center">
                        <div class="mr-3 mb-4 mb-lg-0 text-center text-md-left">
                            <h1 class="h5 mb-1 fw-700">
                                {{ $freelancer->name }}
                                @if($freelancer->profile->nationality)
                                <img src="{{ my_asset('assets/frontend/default/img/flags/'.$freelancer->profile->nationality.'.png') }}" alt="flag" class="ml-1" style="vertical-align: baseline !important;">
                                @endif
                            </h1>
                        ...
                        <div class="text-lg-right d-flex justify-content-between align-items-end d-lg-block">
                            ...
                            <a class="btn btn-primary rounded-1" href="{{ route('invition_for_hire_freelancer', $freelancer->user_name) }}">{{ translate('Hire Me') }}</a>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach ($freelancer->userPortfolios as $key => $portfolio)
                                <div class="col-xxl-3 col-xl-4 col-sm-6">
                                    <a class="card mb-3 shadow-none hov-overlay overflow-hidden">
                                        <img class="card-img-top img-fit" src="{{ custom_asset($portfolio->photo) }}" alt="Image Description">
                        ...
                        @foreach($freelancer->services as $service)
                            <div class="col-lg-4">
                                <div class="card rounded-2 border-gray-light overflow-hidden hov-box">
                                    <a href="{{ route('service.show', $service->slug) }}"><img src="{{ custom_asset($service->image) }}" class="card-img-top img-fit" alt="service_image" height="212"></a>
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('service.show', $service->slug) }}" class="text-dark"><h5 class="card-title fs-16 fw-700">{{ \Illuminate\Support\Str::limit($service->title, 45, $end='...') }}</h5></a>
                                    </div>
                                    <div class="card-footer justify-content-between fs-14">
                                        <span>STARTING AT  {{ count($service->service_packages)>0 ? single_price($service->service_packages[0]->service_price) : single_price(0)}}</span>
                                    </div>
                                </div>
                            </div>
                        @endforeach
            ...
            <div class="col-xxl-3 col-lg-4">
                <div class="card rounded-2 border-gray-light">
                    <div class="card-body">
                        ...
                        <div class="mb-5">
                            <h6 class="text-left mb-4 h6 fw-700"><span class="bg-white pr-3">{{ translate('Skills') }}</span></h6>
                            <div>
                        ...
                        <div class="">
                            <h6 class="text-left mb-4 h6 fw-700"><span class="bg-white pr-3">{{ translate('Verifications') }}</span></h6>
                            <div>
                        ...
                        <div class="mb-3">
                            <h6 class="text-left mb-4 h6 fw-700"><span class="bg-white pr-3">{{ translate('Share Profile') }}</span></h6>
