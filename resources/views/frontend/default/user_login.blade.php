                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" placeholder="{{ translate('Email address') }}" required >
                                @error('email')
                            ...
                            <table class="table table-centered mb-0 table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>123456</td>
                                        <td class="text-right">
                                            <button class="btn btn-outline-info btn-xs rounded-1" onclick="autoFill()">copy</button>
                                        </td >
                                    </tr>
                                    <tr>
                                        ...
                                        <td>123456</td>
                                        <td class="text-right">
                                            <button class="btn btn-outline-info btn-xs rounded-1" onclick="autoFill2()">copy</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
