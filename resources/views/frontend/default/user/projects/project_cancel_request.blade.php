            ...
            <div class="aiz-user-panel">
                <div class="aiz-titlebar mb-4">
                    <div class="row align-items-center">
                        <div class="col">
                            <h1 class="fs-16 fw-700">{{ translate('Cancel') }} - {{ $project->name }}</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('cancel-project-request.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="subject" value="{{ $project->name }}" placeholder="{{ translate('Enter ticket subject') }}" required readonly="">
                            </div>
                            <div class="form-group">
                                <label class="form-label">
