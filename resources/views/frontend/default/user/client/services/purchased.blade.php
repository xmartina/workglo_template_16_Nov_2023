                ...
                <div class="aiz-titlebar mb-4">
                    <div class="row align-items-center">
                        <div class="col d-flex justify-content-between">
                            <h1 class="fs-16 fw-700">{{ translate('Purchased Services') }}</h1>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a target="_blank" href="{{ route('service.show', $purchasedService->servicePackage->service->slug) }}">
                                                ...
                                                @elseif($purchasedService->cancel_requested == 1)
                                                    <span class="badge badge-info badge-inline badge-md">{{ translate('Cancel Requested') }}</span>
                                                @endif
                                            </a>
                                        </td>
                                        ...
                                        @if($purchasedService->cancel_status == 0 && $purchasedService->cancel_requested == 0)
                                            <a href="javascript:void(0)" class="btn btn-secondary btn-sm fw-500 confirm-cancel" data-href="{{route('services.cancel', $purchasedService->id)}}">{{ translate('Cancel') }}</a>                                            
                                        @endif                                        
                                        </td>
                                    @endforeach
                                    </tr>
