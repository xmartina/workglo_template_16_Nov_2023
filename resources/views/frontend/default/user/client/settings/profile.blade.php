                ...
                <div class="aiz-user-panel">
                    <div class="aiz-titlebar mb-4">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h1 class="fs-16 fw-700">{{ translate('Profile Setting') }}</h1>
                            </div>
                        </div>
                    </div>
                            ...
                            <form class="js-validate" action="{{ route('user_profile.bio_update') }}" method="POST"
                                ...
                                <div class="js-form-message">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small
                                            class="form-text text-muted">{{ translate('Only a-z, numbers, hypen allowed') }}</small>
                                    </div>
                                </div>
                                <!-- Input -->
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="email" class="form-control" name="email"
                                            ...
                                            aria-label="{{ translate('Enter your email address') }}" required
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <select class="form-control aiz-selectpicker" name="city_id" id="city_id"
                                                required data-msg="Please select your city." data-live-search="true">
