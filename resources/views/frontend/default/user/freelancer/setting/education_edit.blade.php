            ...
            <div class="aiz-user-panel">
                <div class="aiz-titlebar mb-4">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h1 class="fs-16 fw-700">{{ translate('Education Details Edit') }}</h1>
                        </div>
                    </div>
                </div>
                <div class="card mb-3 rounded-2 border-gray-light">
                    ...
                    <div class="card-body">
                        <form action="{{ route('user_profile.education_info_update', $education->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label id="usernameLabel" class="form-label">{{ translate('Passing Year') }}<span class="text-danger">*</span></label>
                                <div id="datepickerWrapperFrom" class="js-focus-state u-datepicker input-group">
                                    <input type="number" class="form-control" name="passing_year" value="{{ $education->passing_year }}" placeholder="{{ translate('Ex. 2008') }}" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="usernameLabel" class="form-label">{{ translate('Country') }}<span class="text-danger">*</span></label>
                            ...
                            <div class="mt-2 text-right">
                                <!-- Buttons -->
                                <button type="submit" class="btn btn-primary transition-3d-hover rounded-1">{{ translate('Update') }}</button>
                                <!-- End Buttons -->
                            </div>
                        </form>
                    </div>
