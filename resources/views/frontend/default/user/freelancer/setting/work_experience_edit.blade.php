                    ...
                    <div class="card-body">
                        <form action="{{ route('user_profile.work_experience_update', $work_exp->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="company_name" value="{{ $work_exp->company_name }}" placeholder="{{ translate('Company Name') }}" required>
                            </div>
                            <div class="form-group">
                                <label id="usernameLabel" class="form-label">{{ translate('Joining date') }}<span class="text-danger">*</span></label>
                                <input type="text" class="aiz-date-range form-control" name="start_date" placeholder="{{ translate('Select Date') }}" data-single="true" data-show-dropdown="true" autocomplete="off" value="{{ $work_exp->start }}"/>
                            </div>
                            ...
                            <div class="form-group leaving-date">
                                ...
                                <input type="text" class="aiz-date-range form-control" name="end_date" placeholder="{{ translate('Select Date') }}" data-single="true"  data-show-dropdown="true" autocomplete="off" value="{{ $work_exp->end }}"/>
                            </div>
                            <div class="form-group">
                                <label id="usernameLabel" class="form-label">{{ translate('Company Website') }}</label>
                                <input type="text" class="form-control" name="company_website" value="{{ $work_exp->company_website }}" placeholder="{{ translate('Company Website') }}">
                            </div>
                            <div class="form-group">
