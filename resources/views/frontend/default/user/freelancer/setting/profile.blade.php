                ...
                <div class="aiz-user-panel">
                    <div class="aiz-titlebar mb-4">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h1 class="fs-16 fw-700">{{ translate('Profile Settings') }}</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card rounded-2 border-gray-light">
                        ...
                        <div class="card-body">
                            <!-- Personal Info Form -->
                            <form class="js-validate" action="{{ route('user_profile.bio_update') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($user_profile->user->email_verified_at == null)
                                        <span
                                            class="alert alert-danger d-block mt-1 py-1">{{ translate('Verify your email address') }}</span>
                                    @endif
                                </div>
                                <div class="js-form-message">
                                    <div class="form-group">
                                        <label id="nameLabel"
                                            class="form-label">{{ translate('New Password') }}</label>
                                ...
                                <div class="js-form-message">
                                    <div class="form-group">
                                        <label id="nameLabel"
                                            class="form-label">{{ translate('Confirm Password') }}</label>
                                        ...
                                        @if ($user_profile->skills != null)
                                            @foreach (\App\Models\Skill::all() as $key => $skill)
                                                <option value="{{ $skill->id }}"
                                                    @if (in_array($skill->id, json_decode($user_profile->skills))) selected @endif>{{ $skill->name }}
                                                </option>
                                            @endforeach
                                        @else
                                            @foreach (\App\Models\Skill::all() as $key => $skill)
                    ...
                    <div class="card rounded-2 border-gray-light">
                        ...
                        <div class="card-body">
                            ...
                            <form class="js-validate" action="{{ route('user_profile.basic_info_update') }}"
                                ...
                                <div class="js-form-message">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name"
                                            ...
                                            placeholder="{{ translate('Enter your name') }}" aria-label="Enter your name"
                                            required aria-describedby="nameLabel" data-msg="Please enter your name."
                                            data-error-class="u-has-error" data-success-class="u-has-success">
                                        <small
                                            class="form-text text-muted">{{ translate('Displayed on your public profile, notifications and other places') }}.</small>
                                    </div>
                                </div>
                                <div class="js-form-message">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control aiz-selectpicker" id="specialist" name="specialist"
                                            data-live-search="true" required>
                                            @foreach (\App\Models\ProjectCategory::all() as $category)
                                                <option value="{{ $category->id }}"
                                                    @if ($user_profile->specialist == $category->id) selected @endif>
                                ...
                                <div class="js-form-message">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="hourly_rate"
                                            value="{{ $user_profile->hourly_rate }}" placeholder="100" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control aiz-selectpicker" name="gender" required
                                        data-minimum-results-for-search="Infinity" data-msg="Please select your gender."
                                        data-error-class="u-has-error" data-success-class="u-has-success">
                                   ...
                                   <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="postal_code"
                                            class="form-label">{{ translate('Postal Code') }}</label>
                                        <input type="text" id="postal_code" name="postal_code"
                                            @if (optional($user_profile->user->address)->postal_code != null) value="{{ $user_profile->user->address->postal_code }}" @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control aiz-selectpicker country-flag-select" id="nationality"
                                            name="nationality" required data-live-search="true">
                    ...
                    <div class="card rounded-2 border-gray-light">
                        ...
                        <form class="js-validate" action="{{ route('user_profile.photo_update') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                        ...
                        <div class="card-body">
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="card position-relative text-reset mb-3 rounded-1 border-gray-light">
                                                    <img class="img-fit mw-100"
                                                        src="{{ custom_asset($portfolio->photo) }}" height="240">
                            ...
                            @if ($user_profile->user->userPackage->portfolio_add_limit > count($user_profile->user->userPortfolios))
                                <form action="{{ route('user_profile.portfolio_add') }}" method="POST"
                                    ...
                                    @csrf
                                    <div class="form-group">
                                        <label id="usernameLabel" class="form-label">{{ translate('Title') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="portfolio_name"
                                            placeholder="{{ translate('Portfolio title') }}">
                                    </div>
                                    <div class="form-group">
                                        <label id="usernameLabel"
                                            class="form-label">{{ translate('Category') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="portfolio_category"
                                            placeholder="{{ translate('Portfolio Category') }}">
                                    </div>
                                    <div class="form-group">
                                        <label id="usernameLabel" class="form-label">{{ translate('Details') }}<span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mt-2 text-right">
                                            <!-- Buttons -->
                                            <button type="submit"
                                                class="btn btn-primary rounded-1">{{ translate('Add Portfolio') }}</button>
                                            <!-- End Buttons -->
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="card-body">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <ul class="list-unstyled text-secondary mb-0">
                                                            <li class="text-primary">
                                                                {{ $work_experience->company_name }}</li>
                            ...
                            @if ($user_profile->user->userPackage->job_exp_limit > count($user_profile->user->workExperiences))
                                <form action="{{ route('user_profile.work_experience_add') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label id="usernameLabel"
                                            class="form-label">{{ translate('Company Name') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="company_name"
                                            placeholder="{{ translate('Company Name') }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label>{{ translate('Joining date') }} <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group leaving-date">
                                        <label>{{ translate('Leaving date') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="aiz-date-range form-control" name="end_date"
                                            placeholder="{{ translate('Select Date') }}" data-single="true"
                                            data-show-dropdown="true" autocomplete="off" />
                                    </div>
                                    <div class="form-group">
                                        <label id="usernameLabel"
                                            class="form-label">{{ translate('Company Website') }}</label>
                                        <input type="text" class="form-control" name="company_website"
                                            placeholder="{{ translate('Company Website') }}">
                                    </div>
                                    <div class="form-group">
                                        <label id="usernameLabel"
                                            class="form-label">{{ translate('Designation') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="designation"
                                            placeholder="{{ translate('Designation') }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label id="usernameLabel"
                                            class="form-label">{{ translate('Company Location') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="location"
                                            placeholder="{{ translate('Company Location') }}" required>
                                    </div>
                                    <div class="mt-2 text-right">
                                        <!-- Buttons -->
                                        <button type="submit"
                                            class="btn btn-primary rounded-1">{{ translate('Add Work Experience') }}</button>
                                        <!-- End Buttons -->
                                    </div>
                                </form>
                            @else
                    ...
                    <div class="card rounded-2 border-gray-light">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('user_profile.education_info_add') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label id="usernameLabel"
                                ...
                                <div class="form-group">
                                    <label id="usernameLabel"
                                        class="form-label">{{ translate('Passing Year') }}<span
                                            class="text-danger">*</span></label>
                                    <div id="datepickerWrapperFrom" class="js-focus-state u-datepicker input-group">
                                        <input type="number" class="form-control" name="passing_year"
                                            placeholder="{{ translate('Ex. 2008') }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label id="usernameLabel" class="form-label">{{ translate('Country') }}<span
                                            class="text-danger">*</span></label>
                                    <select class="form-control aiz-selectpicker" id="school_country_id" name="country_id"
