                ...
                <div class="aiz-user-panel">
                    <div class="aiz-titlebar mb-4">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h1 class="fs-16 fw-700">{{ translate('Completed Projects') }}</h1>
                            </div>
                        </div>
                    </div>
                    <div class="">
                            ...
                            <div class="card project-card rounded-2 border-gray-light">
                                ...
                                <div class="card-footer">
                                    ...
                                    @if (\App\Models\Review::where('project_id', $project->id)->where('reviewer_user_id', Auth::user()->id)->first() == null)
                                        <button type="button" onclick="showRatingModal({{ $project->id }})" class="btn btn-secondary btn-sm fw-500 rounded-1">{{ translate('Rate This Client') }}</button>
                                    @else
            ...
            <div class="modal-content">
                <form action="{{ route('reviews.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary rounded-1">{{ translate('Rate This Client') }}</button>
                    </div>
                </form
            </div>
        </div>
