                                ...
                                <div class="card-footer flex-wrap">
                                    ...
                                    <div class="mt-3 mt-md-0">
                                        ...
                                        <span class="position-relative">
                                            <a href="javascript:void(0)" onclick="showMessageBox('{{ $project->id }}', '{{ $project->client_user_id }}', '{{ $project->name }}')" class="btn btn-danger btn-sm fw-500 rounded-1 mb-1 mb-sm-0">
                                                {{ translate('Message') }}
                                            </a>
                                        ...
                                        @endif
                                        <a href="javascript:void(0)" onclick="milestone_payment_request_modal('{{ $project->id }}', '{{ $project->client_user_id }}')" class="btn btn-secondary btn-sm fw-500 rounded-1">{{ translate('Send Payment Request') }}</a>
                                    </div>
                                </div>
                            </div>
                        @empty
