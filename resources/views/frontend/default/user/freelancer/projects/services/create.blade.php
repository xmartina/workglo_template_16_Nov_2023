            ...
            <div class="aiz-user-panel">
                <div class="aiz-titlebar mb-4">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h1 class="fs-16 fw-700">{{ translate('Create new service') }}</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <form class="js-validate" action="{{ route('service.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">{{ translate('Basic') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">{{ translate('Standard') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">{{ translate('Premium') }}</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control " name="basic_delivery_time" placeholder="{{ translate('Enter Delivery Time') }}" aria-label="Enter Basic Package Price" required aria-describedby="nameLabel" data-msg="Enter Basic Package Price" data-error-class="u-has-error" data-success-class="u-has-success">
                                    </div>
                                ...
                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">{{ translate('Price') }}</label>
                                        <input type="text" class="form-control " name="standard_price" placeholder="{{ translate('Enter Price') }}" aria-label="Enter Standard Package Price" aria-describedby="nameLabel" data-msg="Enter Standard Package Price" data-error-class="u-has-error" data-success-class="u-has-success">
                                    </div>

                                    <div class="form-group">
                                        <label class="form-label">{{ translate('Devilery Within') }}</label>
                                        <input type="number" class="form-control " name="standard_delivery_time" placeholder="{{ translate('Enter Delivery Time') }}" aria-label="Enter Standard Package Price" aria-describedby="nameLabel" data-msg="Enter Standard Package Price" data-error-class="u-has-error" data-success-class="u-has-success">
                                    </div>

                                    <div class="form-group">
                                        <label class="form-label">{{ translate('Revision Limit') }}</label>
                                        <input type="text" class="form-control " name="standard_revision_limit" placeholder="{{ translate('Enter Revision Limit') }}" aria-label="Enter Standard Package Price" aria-describedby="nameLabel" data-msg="Enter Standard Package Price" data-error-class="u-has-error" data-success-class="u-has-success">
                                    </div>
                                ...
                                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">{{ translate('Price') }}</label>
                                        <input type="text" class="form-control " name="premium_price" placeholder="{{ translate('Enter Price') }}" aria-label="Enter Standard Package Price" aria-describedby="nameLabel" data-msg="Enter Standard Package Price" data-error-class="u-has-error" data-success-class="u-has-success">
                                    </div>

                                    <div class="form-group">
                                        <label class="form-label">{{ translate('Devilery Within') }}</label>
                                        <input type="number" class="form-control " name="premium_delivery_time" placeholder="{{ translate('Enter Delivery Time') }}" aria-label="Enter Standard Package Price" aria-describedby="nameLabel" data-msg="Enter Standard Package Price" data-error-class="u-has-error" data-success-class="u-has-success">
                                    </div>

                                    <div class="form-group">
                                        <label class="form-label">{{ translate('Revision Limit') }}</label>
                                        <input type="text" class="form-control " name="premium_revision_limit" placeholder="{{ translate('Enter Revision Limit') }}" aria-label="Enter Standard Package Price" aria-describedby="nameLabel" data-msg="Enter Standard Package Price" data-error-class="u-has-error" data-success-class="u-has-success">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary transition-3d-hover mr-1 rounded-1">{{ translate('Post Service') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
