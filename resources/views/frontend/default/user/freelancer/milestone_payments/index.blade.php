                ...
                <div class="aiz-user-panel">
                    <div class="aiz-titlebar mb-4">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h1 class="fs-16 fw-700">{{ translate('Total Requests') }}</h1>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($milestones as $key => $milestone)
                                        <tr>
                                            ...
                                            <td>
                                                <button type="submit" class="btn btn-xs btn-primary transition-3d-hover rounded-1" onclick="request_message_show_modal('{{ $milestone->id }}')">Show</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
