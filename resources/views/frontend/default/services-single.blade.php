                    ...
                    <div class="card project-card rounded-2 border-gray-light">
                        <div class="card-body">
                            ...
                            <div class="row align-items-center no-gutters">
                                <img src="{{ custom_asset($service->user->photo)}}" alt=""
                                     class="size-40px rounded-circle">
                                <span class="ml-2"><a href="{{ route('freelancer.details', $service->user->user_name) }}" class="text-reset hov-text-primary">{{ $service->user->name }}</a></span>
        							...
        							<div class="card bg-transparent rounded-2 border-gray-light">
                                        <a href="{{ route('service.show', $similar_type_sevice->slug) }}">
                                            @if($similar_type_sevice->image != null)
                                                <img src="{{ custom_asset($similar_type_sevice->image) }}" class="card-img-top img-fit" alt="service_image" height="212" style="border-radius: 16px 16px 0px 0px;">
                                            @else
