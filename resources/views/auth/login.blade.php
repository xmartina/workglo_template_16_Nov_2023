                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="needs-validation">
                            ...
                            <div class="form-group">
                                <input class="form-control @error('email') is-invalid @enderror" type="email" placeholder="{{ translate('Email') }}" id="email" name="email" autocomplete="off" required >
                                @error('email')
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="submit" class="btn btn-primary rounded-1">{{ translate('Sign In') }}</button>
                            </div>
                            <!--end::Action-->
                        </form>
                        @if (env('DEMO_MODE') == 'On')
                            <div class="d-flex justify-content-between align-items-center mt-4 border p-3">
                                ...
                                <button class="btn btn-sm btn-outline-info rounded-1" onclick="autoFill()">copy</button>
                            </div>
                        @endif
                    </div>
